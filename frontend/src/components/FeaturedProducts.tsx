...
const FeaturedProducts = () => {
  ...
  return (
    <section className="px-4 sm:px-6 lg:px-8 py-6 md:py-20 relative bg-muted/30">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end gap-4 mb-8 lg:mb-16">
          <div className="max-w-2xl">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="font-display text-2xl md:text-5xl font-black mb-3 md:mb-4 tracking-tighter">
                {sectionTitle}
              </h2>
              <div className="w-16 md:w-20 h-1.5 bg-primary mb-4 md:mb-6 rounded-full" />
